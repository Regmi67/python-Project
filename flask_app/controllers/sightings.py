...
def create_sighting():
    ...
    data = {
        ...
        "num_of_Saquatches": int(request.form["num_of_Saquatches"]),
...
def edit_sighting(id):
    ...
    return render_template("edit_sightings.html",edit=Sighting.get_one(data),user=User.get_by_id(user_data))
